...
<head>
    ...
    <meta name="description" content="Reorder Point - Inventory Management System">
    <meta name="keywords" content="inventory management, reorder point, stock management, admin template, dashboard template, responsive admin template, web app">
    <meta name="author" content="Reorder Point System">
    <title>Login - Reorder Point System</title>
                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Reorder Point 📦</h2>
                                <p class="card-text mb-2">Please sign-in to your account and manage your inventory</p>
