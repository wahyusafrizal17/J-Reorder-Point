         ...
         <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-1">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Data Barang Masuk</h2>
                        ...
                        <div class="card">
                           <div class="card-header">
                              ...
                              <a href="{{ route('stock-in.create') }}" class="btn btn-primary btn-sm">
                                 <i data-feather='plus'></i> Tambah Barang Masuk
                              </a>
                          </div>
                           <div class="card-body">
                                       ...
                                       <tr>
                                         ...
                                         <td class="text-center">
                                             <div class="form-button-action">
                                                <a href="{{ route('stock-in.edit',[$row->id]) }}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-sm" data-original-title="Edit">
