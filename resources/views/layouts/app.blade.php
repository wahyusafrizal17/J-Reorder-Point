                ...
                <ul class="nav navbar-nav flex-row">
                    <li class="nav-item me-auto">
                        <a class="navbar-brand" href="../../../html/ltr/vertical-menu-template/index.html">
                            ...
                            <h2 class="brand-text">Reorder Point</h2>
                        </a>
                    </li>
                ...
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="nav-item {!!(Request::is('products*')) ? ' active' : '' !!}">
                        <a class="d-flex align-items-center" href="{{ route('products.index') }}">
                            ...
                            <span class="menu-title text-truncate" data-i18n="Modal Examples">Data Master Barang</span>
                        </a>
                    </li>
                    <li class="nav-item {!!(Request::is('stock-in*')) ? ' active' : '' !!}">
                        <a class="d-flex align-items-center" href="{{ route('stock-in.index') }}">
                            <i data-feather="arrow-down"></i>
                            <span class="menu-title text-truncate" data-i18n="Modal Examples">Barang Masuk</span>
                        </a>
                    </li>
                    <li class="nav-item {!!(Request::is('stock-out*')) ? ' active' : '' !!}">
                        <a class="d-flex align-items-center" href="{{ route('stock-out.index') }}">
                            <i data-feather="arrow-up"></i>
                            <span class="menu-title text-truncate" data-i18n="Modal Examples">Barang Keluar</span>
                        </a>
                    </li>
                    <li class="nav-item {!!(Request::is('reports*')) ? ' active' : '' !!}">
                        <a class="d-flex align-items-center" href="#">
                            <i data-feather="file-text"></i>
                            <span class="menu-title text-truncate" data-i18n="Modal Examples">Laporan</span>
                        </a>
                        <ul class="menu-content">
                            <li>
                                <a class="d-flex align-items-center" href="{{ route('reports.expired-products') }}">
                                    <i data-feather="circle"></i>
                                    <span class="menu-item text-truncate" data-i18n="List">Barang Kedaluwarsa</span>
                                </a>
                            </li>
                            <li>
                                <a class="d-flex align-items-center" href="{{ route('reports.monthly-stock') }}">
                                    <i data-feather="circle"></i>
                                    <span class="menu-item text-truncate" data-i18n="List">Laporan Stok Bulanan</span>
                                </a>
                            </li>
                            <li>
                                <a class="d-flex align-items-center" href="{{ route('reports.stock-summary') }}">
                                    <i data-feather="circle"></i>
                                    <span class="menu-item text-truncate" data-i18n="List">Ringkasan Stok</span>
                                </a>
                            </li>
                            <li>
                                <a class="d-flex align-items-center" href="{{ route('reports.stock-movement') }}">
                                    <i data-feather="circle"></i>
                                    <span class="menu-item text-truncate" data-i18n="List">Pergerakan Stok</span>
                                </a>
                            </li>
                        </ul>
                    </li>
